...
let show = {
    home: function (req, res, next) {
        if(!req.session.passport){            
            res.render("./home/index", {nickName:'', message: null});            
        } else {
            // res.render("./home/index", {nickName:req.session.passport.user, message: () => alert(req.flash('info'))});
            res.render("./home/index", {nickName:req.session.passport.user, message: req.flash('info')});
        }
    },
